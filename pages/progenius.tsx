...
export default function Progenius() {
  return (
    <>
      <Head>
        <title>mrlong - Progenius</title>
        <meta
          name="description"
          content="Progenius: Revolutionizing Crypto Fundraising Management"
        />
        <meta
          name="keywords"
        ...
        <meta property="og:title" content="mrlong - pProgenius" />
        <meta
          property="og:description"
          content="Progenius: Revolutionizing Crypto Fundraising Management"
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://mrlong.vercel.com/progenius" />
        {/*<meta
          property="og:image"
